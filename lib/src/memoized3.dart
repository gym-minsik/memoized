...
/// Represents a memoization wrapper for a computation that takes three arguments
...
class Memoized3<V, A1, A2, A3> {
  ...
  ///
  /// If a cached value for the given pair of arguments ([a1], [a2], [a3]) exists, it
  ...
  ///
  /// The cache uses the pair ([a1], [a2], [a3]) as the key to retrieve stored results.
